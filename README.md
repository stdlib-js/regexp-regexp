...
```javascript
import reRegExp from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-regexp@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-regexp@v0.2.2-deno/mod.js';
```
